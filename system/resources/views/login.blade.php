        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">LALIG</h2>
                    <hr>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="login-wrap p-0">
                        ...
                        <form action="{{ url('login') }}" class="signin-form" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Masokan Email" name='email'
                                    required>
                            </div>
                            <div class="form-group">
                                <input id="password-field" type="password" class="form-control"
                                    placeholder="Masokan Password" name='password' required>
                        ...
                        <p class="w-100 text-center">.......Login Dengan......</p>
