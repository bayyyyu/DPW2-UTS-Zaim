...
class ArtikelController extends Controller
{
    ...
    {
        $artikel = new Artikel();
        $artikel->namapemain = request('namapemain');
        $artikel->posisi = request('posisi');
    ...
    function filter()
    {
        $namapemain = request('namapemain');
        $data['namapemain'] = $namapemain;

        $data['list_artikel'] = Artikel::where('namapemain', 'like', "%$namapemain%")->get();
